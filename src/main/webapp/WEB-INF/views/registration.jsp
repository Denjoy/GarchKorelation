								...
								<form:form class="form-horizontal" method="POST"
									...
									<spring:bind path="username">
										<div class="form-group ${status.error ? 'has-error' : ''}">
											<label for="inputUsername"
												class="col-lg-4 col-md-4 col-sm-4 control-label">Username</label>
											<div class="col-lg-7 col-md-7 col-sm-7">
												<form:input type="text" required="true" class="form-control"
													id="inputUsername" placeholder="Username" path="username"></form:input>
									...
									<div class="form-group ${status.error ? 'has-error' : ''}">
										<label for="inputEmail"
											class="col-lg-4 col-md-4 col-sm-4 control-label">Email</label>
										<div class="col-lg-7 col-md-7 col-sm-7">
											<form:input type="email" required="true" class="form-control"
												id="inputEmail" placeholder="Email" path="email"></form:input>
											<form:errors path="email" class="error"></form:errors>
										</div>
									</div>
									<div class="form-group ${status.error ? 'has-error' : ''}">
										<label for="inputEmail"
											class="col-lg-4 col-md-4 col-sm-4 control-label">Confirm
											Email</label>
										<div class="col-lg-7 col-md-7 col-sm-7">
											<form:input type="email" required="true" class="form-control"
												placeholder="Email" path="emailConfirm"></form:input>
											<form:errors path="emailConfirm" class="error"></form:errors>
										</div>
									</div>
									<div class="form-group ${status.error ? 'has-error' : ''}">
										<label for="inputPassword"
											class="col-lg-4 col-md-4 col-sm-4 control-label">Password</label>
										<div class="col-lg-7 col-md-7 col-sm-7">
									...
									<div class="form-group ${status.error ? 'has-error' : ''}">
										...
										<div class="col-lg-7 col-md-7 col-sm-7">
											<form:input type="password" required="true"
												...
												placeholder="Confirm password" path="passwordConfirm"></form:input>
											<form:errors path="passwordConfirm" class="error"></form:errors>
										</div>
									</div>
									<div class="form-group ${status.error ? 'has-error' : ''}">
										<label for="inputCountry"
											class="col-lg-4 col-md-4 col-sm-4 control-label">Country</label>
										<div class="col-lg-7 col-md-7 col-sm-7">
									...
									<div class="form-group">
										<div
											class="col-lg-offset-4 col-lg-7 col-md-offset-4 col-md-7 col-sm-offset-4 col-sm-7">
											<div class="checkbox">
												<label> <form:checkbox path="receiveNewsletter"
														checked="true" /> I wish to get newsletters
												</label>
											</div>
										</div>
									</div>
