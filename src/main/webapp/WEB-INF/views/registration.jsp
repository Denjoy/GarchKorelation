...
<body class="modiphius-bg">
	...
	<div class="content page-register page-form">

		<div class="container">
			<div class="row">
				<div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="breadcrumps">
						<a href="home.html">Home</a> / Register
					</div>
				</div>
			</div>
			<div class="row">
						...
						<div class="row">
							<div class="col col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 col-xs-12">
								...
								<p style="text-align: center;">
									Come join the Modiphians community!<br />Let's set up your account. Already have one? <a href="login.html">Sign&nbsp;in&nbsp;here.</a>
								</p>
								<form:form class="form-horizontal" method="POST" modelAttribute="userForm">
									<spring:bind path="username">
										<div class="form-group ${status.error ? 'has-error' : ''}">
											<label for="inputUsername" class="col-lg-4 col-md-4 col-sm-4 control-label">Username</label>
											<div class="col-lg-7 col-md-7 col-sm-7">
												<form:input type="text" required="true" class="form-control" id="inputUsername" placeholder="Username" path="username"></form:input>
									...
									<div class="form-group ${status.error ? 'has-error' : ''}">
										...
										<div class="col-lg-7 col-md-7 col-sm-7">
											<form:input type="email" required="true" class="form-control" id="inputEmail" placeholder="Email" path="email"></form:input>
											<form:errors path="email" class="error"></form:errors>
										</div>
									</div>
									<div class="form-group ${status.error ? 'has-error' : ''}">
										<label for="inputEmail" class="col-lg-4 col-md-4 col-sm-4 control-label">Confirm Email</label>
										<div class="col-lg-7 col-md-7 col-sm-7">
											<form:input type="email" required="true" class="form-control" placeholder="Email" path="emailConfirm"></form:input>
											<form:errors path="emailConfirm" class="error"></form:errors>
										</div>
									</div>
									<div class="form-group ${status.error ? 'has-error' : ''}">
										<label for="inputPassword" class="col-lg-4 col-md-4 col-sm-4 control-label">Password</label>
										<div class="col-lg-7 col-md-7 col-sm-7">
											<form:input type="password" required="true" class="form-control" id="inputPassword" placeholder="Password" path="password"></form:input>
											<form:errors path="password" class="error"></form:errors>
										</div>
									</div>
									<div class="form-group ${status.error ? 'has-error' : ''}">
										<label for="inputConfirmPassword" class="col-lg-4 col-md-4 col-sm-4 control-label">Confirm password</label>
										<div class="col-lg-7 col-md-7 col-sm-7">
											<form:input type="password" required="true" class="form-control" id="inputConfirmPassword" placeholder="Confirm password" path="passwordConfirm"></form:input>
											<form:errors path="passwordConfirm" class="error"></form:errors>
										</div>
									</div>
									<div class="form-group ${status.error ? 'has-error' : ''}">
										<label for="inputCountry" class="col-lg-4 col-md-4 col-sm-4 control-label">Country</label>
										<div class="col-lg-7 col-md-7 col-sm-7">
											<form:select required="true" class="form-control" name="country" path="country">
									...
									<div class="form-group">
										<div class="col-lg-offset-4 col-lg-7 col-md-offset-4 col-md-7 col-sm-offset-4 col-sm-7">
											<div class="checkbox">
												<label> <form:checkbox path="receiveNewsletter" checked="true" /> I wish to get newsletters
												</label>
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="col-lg-offset-4 col-lg-7 col-md-offset-4 col-md-7 col-sm-offset-4 col-sm-7">
											<div class="checkbox">
												<label> <input type="checkbox" required="true"> I agree with the <a href="#">Terms &amp; Conditions</a>
												</label>
											</div>
										</div>
									</div>
