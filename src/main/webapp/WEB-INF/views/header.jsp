...
<div class="container">
	...
	<div class="row header-main">
		...
		<div class="col col-xs-12 col-sm-8 col-md-9 col-lg-9 header-menu">
			<div class="row">
			<div class="col-lg-2"><p>GarchProject</p></div>
			<div class="col-lg-10">
			<a href="${contextPath}/">Home</a> 
			<a href="${contextPath}/stock">Котирування акцій</a>
			<a href="#">Про сайт</a>
			</div>
			</div>
		</div>
	...
	<div class="homeText">
		<h1>Для того щоб скористатись всіма функціями зареєструйтесь, або ввійдіть як користувач</h1>
		<p></p>
		</div>
</div>