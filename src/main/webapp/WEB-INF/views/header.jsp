...
<div class="container">
	<div class="row">
		...
		<security:authorize access="hasAnyRole('ROLE_ADMIN', 'ROLE_MODERATOR')">
			...
			Join Us<security:authorize access="hasRole('ROLE_USER')">,&nbsp;${pageContext.request.userPrincipal.name} </security:authorize>!
			 <a href="#">
			<i class="fa fa-facebook"></i></a> <a href="#">
			<i class="fa fa-twitter"></i> <a href="#">
			<i class="fa fa-envelope"></i> <a href="#">
			<i class="fa fa-google-plus"></i> <a href="#">
			<i class="fa fa-youtube"></i> <a href="#">
			&nbsp;&nbsp;&nbsp;
			<security:authorize access="hasRole('ROLE_ANONYMOUS')">
				<a href="registration.html">Register</a>&nbsp;or&nbsp;<a href="login.html">Login</a>
			</security:authorize>
